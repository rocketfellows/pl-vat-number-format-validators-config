...
namespace rocketfellows\PLVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\PLVatNumberFormatValidatorsConfig\PLVatNumberFormatValidatorsConfig;

class PLVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = PLVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = PLVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::PL(), $config->getCountry());
    }
